...
* Combines and minifies CSS (Closure Stylesheets)
...
* Runs your CSS through a code quality tool, (Closure Stylesheets, not optional at this point)
* Cache-busting support for a module directory
* Precompiles LESS formatted CSS (Closure Stylesheets, not optional at this point)
* Optionally output JSDOC3 documentation


## Add the build script to your project

The h5bp build script (https://github.com/h5bp/ant-build-script) has already been added to this project.
